...
Passes older than the five most recent, moved out of `HANDOFF.md` so
starting a task does not cost a hundred kilobytes of reading. Nothing
here is current. Consult it only when something specific needs
explaining.
