...
_MOSS = (32, 66, 43)
_FEYWILD_GROUND = (38, 79, 48)
_DEEP_WATER = (13, 61, 78)
_WATER = (27, 126, 141)
_WATER_LIGHT = (105, 220, 196)
_FOAM = (190, 240, 219)
_LEAF_DARK = (20, 83, 45)
_LEAF = (43, 131, 62)
_FLOWER = ((220, 92, 167), (236, 184, 71), (124, 151, 239))
...
class FeywildRiverCutsceneScene(Scene):
    ...
    def _draw_banks(
        ...
        for index in range(26):
            ...
            if wild > 0.72 and index % 4 == 0:
                pygame.draw.rect(
                    surface, _FLOWER[(index // 4) % len(_FLOWER)],
                    (x + side * 7, y - 3, 2, 2),
                )
    ...
    def _draw_quiet_bank(self, surface: pygame.Surface) -> None:
        ...
        for index in range(18):
            ...
            if index % 4 == 0:
                pygame.draw.rect(
                    surface, _FLOWER[index % len(_FLOWER)],
                    (x + 5, y - 2, 2, 2),
                )
        ...
        if frame is not None:
            image = pygame.transform.rotate(frame, 90)
            surface.blit(image, (shore_x + 21, 104))
