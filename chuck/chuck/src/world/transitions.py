...
AREA_WALK_EXITS: dict[tuple[str, str], AreaExit] = {
    ...
    ("desert_central", "⮞"): AreaExit(
        "desert_east_1", "from_desert_central", "right"
    ),
    ("desert_east_1", "⮜"): AreaExit(
        "desert_central", "from_east_1", "left"
    ),
    ("desert_east_1", "⮞"): AreaExit(
        "desert_east_2", "from_east_1", "right"
    ),
    ("desert_east_2", "⮜"): AreaExit(
        "desert_east_1", "from_east_2", "left"
    ),
    ("desert_east_2", "⮞"): AreaExit(
        "desert_east_3", "from_east_2", "right"
    ),
    ("desert_east_3", "⮜"): AreaExit(
        "desert_east_2", "from_east_3", "left"
    ),
    ("desert_east_3", "⮞"): AreaExit(
        "desert_east_4", "from_east_3", "right"
    ),
    ("desert_east_4", "⮜"): AreaExit(
        "desert_east_3", "from_east_4", "left"
    ),
    ("desert_east_4", "⮞"): AreaExit(
        "desert_east_5", "from_east_4", "right"
    ),
    ("desert_east_5", "⮜"): AreaExit(
        "desert_east_4", "from_east_5", "left"
    ),
    ("desert_east_5", "⮞"): AreaExit(
        "desert_east_6", "from_east_5", "right"
    ),
    ("desert_east_6", "⮜"): AreaExit(
        "desert_east_5", "from_east_6", "left"
    ),
    ("desert_east_6", "⮞"): AreaExit(
        "desert_east_7", "from_east_6", "right"
    ),
    ("desert_east_7", "⮜"): AreaExit(
        "desert_east_6", "from_east_7", "left"
    ),
    ("desert_east_7", "⮞"): AreaExit(
        "desert_east_8", "from_east_7", "right"
    ),
    ("desert_east_8", "⮜"): AreaExit(
        "desert_east_7", "from_east_8", "left"
    ),
    ("desert_east_8", "⮞"): AreaExit(
        "desert_trio", "from_east_8", "right"
    ),
    ("desert_trio", "⮜"): AreaExit(
        "desert_east_8", "from_trio", "left"
    ),
...
AREA_MUSIC: dict[str, str | None] = {
    ...
    "desert_east_1": "desert.wav",
    "desert_east_2": "desert.wav",
    "desert_east_3": "desert.wav",
    "desert_east_4": "desert.wav",
    "desert_east_5": "desert.wav",
